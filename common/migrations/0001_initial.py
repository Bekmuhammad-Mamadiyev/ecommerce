...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to='media/filess', verbose_name='File')),
                ('type', models.CharField(choices=[('image', 'Image'), ('video', 'Video'), ('music', 'Music'), ('file', 'File')], max_length=60, verbose_name='Type')),
            ],
        ),
        migrations.CreateModel(
